...
export default function AdminReportsPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:4000'}/admin/reports?${query.toString()}`, {
                    headers: {
    ...
    useEffect(() => {
        ...
        router.push(`/admin/reports?${query.toString()}`, { scroll: false })
    ...
    return (
        <div className="space-y-6">
            ...
            <Tabs defaultValue="open" value={status} onValueChange={(v) => { setStatus(v); setPage(1); }}>
                <TabsList>
