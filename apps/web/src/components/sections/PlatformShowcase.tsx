                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {platforms.map((platform, idx) => (
                        ...
                        >
                            ...
                            />
                            <div className="relative h-full bg-surface border border-white/5 rounded-2xl p-8 text-center hover:border-white/10 transition-all duration-300">
                                <div
                                    className="inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 transition-transform duration-300 group-hover:scale-110"
                                    style={{
