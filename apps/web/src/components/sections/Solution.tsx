                ...
                <div className="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
                    ...
                    {steps.map((step, index) => (
                        <article key={index} className="relative text-center">
                            {/* Step number */}
                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 bg-background rounded-full text-xs font-semibold text-primary border border-primary/20" aria-hidden="true">
                                {step.number}
                            </div>
